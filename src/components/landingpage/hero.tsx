...
import image from "../../assets/images/employeeimage.avif"

function hero() {
  return (
      <main id="home" className="flex flex-col md:flex-row items-center mt-20 justify-between flex-1 px-10 md:px-20 py-0 md:pb-4 md:pt-4">
        ...
        <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center">
          <img src={image}  alt="employees" className="w-80 md:w-[400px]"/>          
        </div>
      </main>
  )
}
